...
\chapter*{Histórico de Revisões}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}[pos]{|m{2cm} | m{8cm} | m{4cm}|} 
      ...
      29/10/2014 & Adição do diagrama de classe do estagio 2 & patrickecomp e mirelarios \\ \hline
      29/10/2014 & Adição das descrições dos componentes & manuellemacedo \\ \hline
      29/10/2014 & Descrição entradas e saídas de Instruction Decode & patrickecomp e mirelarios \\ \hline
      30/10/2014 & Adição do Datapath (Instruction Fetch) & santana22 e gabri14el \\ \hline
      30/10/2014 & Adição da tabela de microinstruções & patrickecomp e mirelarios \\ \hline
    \end{tabular}
  \end{table}
