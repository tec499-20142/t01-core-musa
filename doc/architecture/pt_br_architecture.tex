...
\chapter*{Histórico de Revisões}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}[pos]{|m{2cm} | m{8cm} | m{4cm}|} 
      ...
      10/12/2014 & Atualização da tabela de microinstruções  & mirelarios \\ \hline
      10/12/2014 & Modificando as informações contidas nos diagramas de classe de cada estágio  & santana22 \\ \hline
      11/12/2014 & Refatoração da introdução e codificação & manuellemacedo \\ \hline
      11/12/2014 & Alteração no datapath do Intruction Fetch  & mirelarios \\ \hline
    \end{tabular}
  \end{table}
...
\chapter{Descrição da Arquitetura}
	...
	\input{step4}
	\newpage
	%Gerar nova imagem do DATAPATH (Tarles)
	\begin{landscape}
