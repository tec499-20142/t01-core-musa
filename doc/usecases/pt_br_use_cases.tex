...
\section*{\center Histórico de Revisões}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}[pos]{|m{2cm} | m{7.2cm} | m{3.8cm}|} 
      ...
      \small 09/10/2014 & \smal Retirado alguns atores do documento. Modificado os Casos de uso da Unidade de Controle e da UL. Adicionado algumas
      definições de siglas do Diagrama de Caso de Uso. & \small lucas e Anderson \\ \hline 
    \end{tabular}
  \end{table}
