...
\section*{\center Histórico de Revisões}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}[pos]{|m{2cm} | m{7.2cm} | m{3.8cm}|} 
      ...
      \small 26/09/2014 &
      \small Inclusão dos requisitos [FR1] à [FR8] retirados do WARM-UP & \small patrickecomp \\ \hline 
      \small 28/09/2014 & \small Inclusão dos requisitos [FR9] à [FR13] & \small santana22 e gabri14el \\ \hline
...
Texto do Levantamento de requisitos do problema 01 abaixo para que possamos aqui desenvolver uma introdução seguindo esse texto como exemplo.
