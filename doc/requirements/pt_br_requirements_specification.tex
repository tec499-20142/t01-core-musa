...
\small 06/10/2014 & \small Adição dos requisitos [FRxx] à [FRxx] & \small manuellemacedo \\ \hline %operações com imediato
...
\small 06/10/2014 & \small Adição dos requisitos [FRxx] à [FRxx] & \small manuellemacedo \\ \hline % flags

\small 8/10/2014 & \samll Adicionado a dependência do documento de requisitos da Processing Unit & \small Anderson e Lucas \\ \hline 		      
		\end{tabular}
	\end{table}
